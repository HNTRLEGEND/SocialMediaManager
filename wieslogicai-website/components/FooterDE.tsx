...
const footerLinks = {
  loesungen: [
    { name: 'KI Voice Agent', href: '/#workflows' },
    { name: 'Lead-Qualifizierung', href: '/#workflows' },
    { name: 'Sales Automatisierung', href: '/#workflows' },
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-16 pb-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                10X Wachstum durch KI-Automatisierung. Wir implementieren intelligente Workflows, die 24/7 für Sie arbeiten.
              </p>
        ...
        >
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-6">
              Erhalten Sie wöchentlich Insights zu KI-Automatisierung, Branchentrends und exklusive Tipps.
            </p>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Tenify.AI. Alle Rechte vorbehalten.
          </p>
