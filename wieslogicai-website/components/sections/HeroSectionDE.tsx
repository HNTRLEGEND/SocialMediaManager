      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <span className="block">10X Wachstum durch</span>
            ...
            >
              <span className="font-semibold text-white">Tenify.AI</span> automatisiert Ihre Geschäftsprozesse.{' '}
              <span className="text-electric-500 font-semibold">24/7</span> einsatzbereit,{' '}
              <span className="text-electric-500 font-semibold">DSGVO-konform</span>, ohne Personalaufwand.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>200% Effizienzsteigerung im Schnitt</span>
              </div>
              <div className="hidden sm:block w-1 h-1 bg-gray-600 rounded-full" />
              <div>In 48h einsatzbereit</div>
            </motion.div>
          </motion.div>
