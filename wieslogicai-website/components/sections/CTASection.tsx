...
const ctaOptions = [
  {
    icon: Calendar,
    title: 'Demo buchen',
    description: '15 Minuten Live-Demo – sehen Sie die KI in Aktion',
    cta: 'Termin wählen',
    href: '/de/kontakt',
    color: 'electric',
    popular: true
  },
  {
    ...
    description: 'Direkt chatten – unser Team antwortet innerhalb von 2h',
    cta: 'Chat starten',
  ...
  },
  {
    icon: Phone,
    title: 'Anrufen',
    description: 'Sprechen Sie mit einem Experten – Mo-Fr 9-18 Uhr',
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
            Buchen Sie eine kostenlose 15-Minuten-Beratung und erfahren Sie,{' '}
            <span className="text-white font-semibold">wie viel Zeit und Geld</span>{' '}
            Sie mit KI-Automatisierung sparen können.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-gray-400">
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
              <span>Individuelle Potenzialanalyse</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-gray-300">
            ...
            <p className="text-lg">
              <span className="text-white font-semibold">14 Tage kostenlos testen,</span> dann 30 Tage Geld-zurück-Garantie
            </p>
            <Sparkles className="w-6 h-6 text-gold-500" />
          </div>
        </motion.div>
