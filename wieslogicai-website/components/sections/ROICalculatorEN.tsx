      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-6xl font-bold text-white mb-6">
            <span className="block">How much are you losing</span>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Calculate your savings potential with our AI Voice Agent in 60 seconds
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="flex items-start gap-3 p-4 bg-electric-500/10 border border-electric-500/30
              ...
              <p className="text-sm text-gray-300">
                <strong className="text-white">Conservative estimate:</strong> We calculate with 30% conversion rate
                for missed calls - the real number may be higher.
              </p>
            </div>
          </motion.div>
          ...
          >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-300 mt-1">
                    ≈ {formatCurrency(results.yearlyLoss)} per year
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-300 mt-1">
                    after deducting €999 subscription cost
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-white/5 rounded-2xl">
                    ...
                    <div className="text-xs text-gray-400">in first year</div>
                  </div>
            ...
            >
              <button className="w-full px-8 py-5 bg-gradient-to-r from-electric-500 to-neon-500
                ...
                Book free consultation & save {formatCurrency(results.totalLoss - 999)}/month
              </button>
              <p className="text-sm text-gray-400 mt-4">
                ✓ 30-day trial ✓ No setup fee ✓ Cancel monthly
              </p>
            </motion.div>
          </motion.div>
        </div>
