      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <span className="block">10X Your Business</span>
            ...
            >
              <span className="font-semibold text-white">WiesLogicAI</span> helps you automate, optimize, and{' '}
              <span className="text-electric-500 font-semibold">dominate</span>.
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>200% Avg. Efficiency Gain</span>
              </div>
              <div className="hidden sm:block w-1 h-1 bg-gray-600 rounded-full" />
              <div>45-Day Implementation</div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-primary-800/50 to-primary-900/50
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="px-3 py-1 bg-green-500/20 border border-green-500/50
                  rounded-full text-green-400 text-xs font-semibold uppercase tracking-wider
                  animate-pulse-glow">
                  Live
                </div>
              </div>
              ...
              <div className="space-y-4 mb-6">
                {[
                  { label: 'Voice Agent Calls', value: '1,247', change: '+23%', color: 'electric' },
                  { label: 'Tasks Automated', value: '8,932', change: '+187%', color: 'neon' },
                  { label: 'Time Saved (Hours)', value: '542', change: '+94%', color: 'gold' },
                ].map((metric, index) => (
                  <motion.div
                    key={index}
                    ...
                    className="flex items-center justify-between p-4
                      bg-primary-800/50 rounded-2xl border border-white/5
                      hover:border-white/10 transition-colors"
                  >
                    <div>
                      <div className="text-sm text-gray-400 mb-1">{metric.label}</div>
                      <div className={`text-2xl font-display font-bold text-${metric.color}-500`}>
                        {metric.value}
                      </div>
                    </div>
              ...
              <motion.div
                ...
                className="p-4 bg-gradient-to-r from-electric-500/10 to-neon-500/10
                  border border-electric-500/30 rounded-2xl"
              >
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-electric-500/20 rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white leading-relaxed">
                      "Hi! I'm your WiesLogic AI assistant. Ready to see how we can{' '}
                      <span className="text-electric-500 font-semibold">10X your automation</span>?"
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-electric-500/20 to-neon-500/20
                rounded-3xl blur-xl -z-10 opacity-50" />
            </div>
