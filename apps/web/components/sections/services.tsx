...
// ServicesSection: Zeigt die vier Kernleistungen von WIES.AI in animierten Karten.
// Die Inhalte werden aus der zentralen Datenquelle `lib/data.ts` gelesen.
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-12">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {services.map((service, index) => (
            // Jede Karte erhält eine leichte Verzögerung für einen Staffel-Look
